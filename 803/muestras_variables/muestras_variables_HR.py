...
with engine.connect() as connection2:
    ...
    query2 = """SELECT CASE
                ...
                WHERE VARIABLE IN ('140') AND ID_MUESTREO IN (81620180118151515,81620180119151148,81620180122132412,81620180122160828,
    ...
    for _, df_muestra in datos2Df.groupby('ID_MUESTRA'):
        ...
        insertHR = f"""INSERT INTO AGD_MUESTRAS_VARIABLES (ID_PARAMETRO, ID_METODOLOGIA, ID_UNIDAD_MEDIDA, ID_MUESTRA, ID_METODO, VALOR) 
        VALUES({140},{803},{4},{df_muestra['ID_MUESTRA'].values[0]}, {673}, {df_muestra['VALOR'].values[0]})"""
        
        muestras.append(insertHR)
    ...
    muestras.to_csv('muestras_variables_HR.csv', index=False)
