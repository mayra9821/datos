...
with engine.connect() as connection2:
    ...
    query2 = """SELECT CASE
                ...
                WHERE VARIABLE IN ('141') AND ID_MUESTREO IN (81620180122093517,81620180411132118,81620180412080901,
    ...
    for _, df_muestra in datos2Df.groupby('ID_MUESTRA'):
        ...
        insertPAT = f"""INSERT INTO AGD_MUESTRAS_VARIABLES (ID_PARAMETRO, ID_METODOLOGIA, ID_UNIDAD_MEDIDA, ID_MUESTRA, ID_METODO, VALOR)
                        VALUES({141},{803},{65},{df_muestra['ID_MUESTRA'].values[0]}, {838}, {df_muestra['VALOR'].values[0]})"""
        
        muestras.append(insertPAT)
